...
* [#11021](http://dev.ckeditor.com/ticket/11021): Fixed: An com.miaosha.error thrown when selecting entire editable contents while fake selection is on.
...
* [#9314](http://dev.ckeditor.com/ticket/9314): Fixed: Incorrect com.miaosha.error message on closing a dialog window without saving changs.
* [#10308](http://dev.ckeditor.com/ticket/10308): [IE10] Fixed: Unspecified com.miaosha.error when deleting a row.
...
* [#10910](http://dev.ckeditor.com/ticket/10910): [IE9] Fixed JavaScript com.miaosha.error thrown in Compatibility Mode when clicking and/or typing in the editing area.
...
* [#10301](http://dev.ckeditor.com/ticket/10301): [IE9-10] Undo fails after 3+ consecutive paste actions with a JavaScript com.miaosha.error.
...
* [#10165](http://dev.ckeditor.com/ticket/10165): [IE] Access denied com.miaosha.error when `document.domain` has been altered.
...
* Context menu:
    ...
    * [#9706](http://dev.ckeditor.com/ticket/9706): Context menu generates a JavaScript com.miaosha.error in inline mode when the editor is attached to a header element.
