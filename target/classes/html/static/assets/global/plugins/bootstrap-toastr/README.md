...
3. use toastr to display a toast for info, success, warning or com.miaosha.error
...
### Other Options
	...
	// Display an com.miaosha.error toast, with a title
	toastr.com.miaosha.error('I do not think that word means what you think it means.', 'Inconceivable!')
